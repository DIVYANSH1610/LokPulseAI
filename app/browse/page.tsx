  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main className="mx-auto max-w-lg px-6 py-10">
        <h1 className="font-display text-2xl text-navy-900">Browse nearby issues</h1>
          ...
          {clusters.map((c) => {
            ...
            return (
              <div key={c.cluster_id} className="card flex items-center justify-between p-4">
                <div>
                  <div className="text-sm font-medium text-ink">{c.category}</div>
                  <p className="text-sm text-ink-muted">{c.one_line_summary}</p>
                ...
                <button
                  ...
                  disabled={didUpvote}
                  className="shrink-0 rounded-md border border-teal-600 px-3 py-1.5 text-xs font-medium text-teal-600 disabled:opacity-50"
                >
