  ...
  return (
    <div className="min-h-screen bg-[var(--paper)]">
      ...
      <main className="mx-auto max-w-lg px-6 py-10">
        <h1 className="font-display text-2xl text-[var(--navy-900)]">My submissions</h1>
          ...
          {items.map((item) => (
            <div key={item.submission_id} className="card p-4">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-[var(--ink)]">{item.category}</span>
                <span
              ...
              <p className="mt-1 text-sm text-[var(--ink-muted)]">{item.summary}</p>
